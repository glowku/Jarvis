...
[![Platform](https://img.shields.io/badge/Architecture-x86__64-blue.svg)]()
[![Kernel](https://img.shields.io/badge/Kernel-Custom_Limine-orange.svg)]()
...
1.  **Réduction de Latence :** Zéro appel système (Syscalls) entre l'IA et le matériel.
2.  **Gestion Fibreuse :** Allocation mémoire dynamique basée sur la topologie des neurones.
3.  **Agnosticisme :** Le moteur de calcul (Myst AI) est conçu pour être portable entre l'hôte (Windows/WSL) et l'invité (Jarvis OS).
